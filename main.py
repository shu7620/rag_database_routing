...
# --- CHANGED: Imports for Google Gemini ---
from langchain_google_genai import GoogleGenerativeAIEmbeddings, ChatGoogleGenerativeAI
# ------------------------------------------
import tempfile
from agno.agent import Agent
# --- CHANGED: Import for Agno Google Model ---
...
def initialize_models():
    """Initialize Google Gemini models and Qdrant client"""
    # --- CHANGED: Check for google_api_key ---
    if (st.session_state.google_api_key and 
        ...
        try:
            ...
            # --- CHANGED: Vector size for Google embedding-001 is 768 ---
            vector_size = 768 
            # ------------------------------------------------------------
...
def main():
    ...
    with st.sidebar:
        ...
        # --- CHANGED: Check google_api_key ---
        if (st.session_state.google_api_key and 
            st.session_state.qdrant_url and 
            st.session_state.qdrant_api_key):
            if initialize_models():
                st.success("Connected to Google Gemini and Qdrant successfully!")
            else:
